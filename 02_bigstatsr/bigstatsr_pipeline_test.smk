...
for diagnosis in diagnoses_to_run:
    ...
    # concatenate folder name with file name
        ...
        output_files.append(f"{diagnosis}_{control}_{cohort}_{input_type}/train_predictions_{diagnosis}_{control}_{cohort}_{input_type}.csv")
        output_files.append(f"{diagnosis}_{control}_{cohort}_{input_type}/metrics_{diagnosis}_{control}_{cohort}_{input_type}.csv")
        output_files.append(f"{diagnosis}_{control}_{cohort}_{input_type}/roc_curve_{diagnosis}_{control}_{cohort}_{input_type}.pdf")
        output_files.append(f"{diagnosis}_{control}_{cohort}_{input_type}/distr_cc_{diagnosis}_{control}_{cohort}_{input_type}.pdf")
        output_files.append(f"{diagnosis}_{control}_{cohort}_{input_type}/valid_perf_{diagnosis}_{control}_{cohort}_{input_type}.pdf")
        # output_files.append(f"{diagnosis}_{control}_{cohort}_{input_type}/confusion_matrix_{diagnosis}_{control}_{cohort}_{input_type}.pdf")
...
rule bigstatsr:
    ...
    output:
        model_file="{diagnosis}_{control}_{cohort}_{input_type}/model_{diagnosis}_{control}_{cohort}_{input_type}.rds",
    ...
    log:
        "logs/bigsnpr_{diagnosis}_{control}_{cohort}_{input_type}.log"
    ...
    shell:
        ...
        Rscript bigstatsr.R --bedfile {params.bedfile} \
        ...
        --valid-perf-file {output.valid_perf_file} \
        2> {log}
        """
